...
# from pl_bolts.optimizers.lr_scheduler import LinearWarmupCosineAnnealingLR  # Not compatible with PyTorch Lightning 2.x

# Custom implementation to avoid pl_bolts dependency
import math
